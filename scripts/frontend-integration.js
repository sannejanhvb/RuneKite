 ...
 * This file demonstrates how to integrate Runekite with a web frontend
 */

// For React/Vue/Angular applications
export class RunekiteClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RunekiteClient(provider, contractAddress);
